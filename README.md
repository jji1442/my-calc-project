...
### 자세한 설명은 기능 요구사항의 전제조건을 참고 바랍니다. [>> 전제조건 보러가기](#prototype_prerequisites)
...
4. 전제조건: 기능 요구사항의 전제조건 문서를 참조 바랍니다. [>> 전제조건 보러가기](#prototype_prerequisites)
5. 사용한 언어: python.
...
7. 핵심 로직: 구현 설명의 핵심 로직 문서를 참조 바랍니다. [>> 핵심 로직 보러가기](#prototype_main_logic)
8. 시제품 사용 방법:<br>
