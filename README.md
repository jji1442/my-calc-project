...
&emsp;calc_enh_cnt_for_skill_core_list()라는 함수는 스킬 코어 리스트(오리진 스킬, 어센트 스킬)를 위한 강화 횟수 계산하는 함수입니다.<br>
따로 계산하는 이유는 스킬 코어에 10레벨 단위로 보스에게 적용되는 데미지 증가 또는 방어율 무시 증가인 부가 효과의 효율을 측정하여 우선적으로 강화할 가치가 있는지 확인하기 위해섭니다.

&emsp;강화 횟수를 추천해주기 위해선 데미지적 이점과 비용적 이점. 이 2가지를 비교해야 합니다.

강화 횟수를 추천해주기 위해선 부가 효과의 효율을 계산하여, 선제적으로 강화의 이점이 큰 지 후순위로 강화의 이점이 큰 지를 비교해야 합니다.

&emsp;선제적으로 강화의 이점이 큰 지 확인하는 방법은 부가 효과가 부여되는 레벨의 이전 레벨과 효율을 비교하여 우열을 가려내는 행위입니다.<br>
...
후자가 좋다면, '8레벨 -> 9레벨'의 효율 보다 좋지 않으니 데미지적 이점 면에서는 '9레벨 -> 10레벨'라는 결과를 내놓게 되는 구조입니다.

&emsp;첫 부가 효과인 10레벨을 기준으로 비용적 이점의 경우에는 '10레벨 -> 11레벨'의 재화 소모량(80개)이 '9레벨 -> 10레벨'의 재화 소모량(200개)에 비해 적다는 점을 이용하여 계산하였을 때, '9레벨 -> 14레벨'의 평균 재화 소모량(총 580개, 평균 레벨당 116개)이 '14레벨 -> 15레벨'의 재화 소모량(120개) 보다 적습니다.<br>
결과적으로 비용적 이점 면에서는 '9레벨 -> 14레벨'이 가장 효율이 좋음을 알 수 있습니다.

&emsp;첫 부가 효과인 10레벨을 기준으로 비용적 이점의 경우에는 부가 효과의 데미지적 상승율에 따라 비용적 이점이 달라지기 때문에, 다음 레벨과 효율을 비교합니다.<br>

결과적으로 비용적 이점 면에서는 '9레벨 -> 14레벨'이 가장 효율이 좋음을 알 수 있습니다.



&emsp;데미지적 이점의 산출 방식으로는, 선제적으로 부가 효과가 부여되는 레벨의 이전 레벨과 효율을 비교합니다.<br>
예를 들자면, '8레벨 -> 10레벨'의 효율 vs. '8레벨 -> 9레벨'의 효율. 이 2가지의 수치를 비교하여 효율이 좋은 쪽을 가려내는 겁니다.<br>
전자가 좋다면, 이어서 '7레벨 -> 10레벨'의 효율 vs. '7레벨 -> 8레벨'의 효율을 측정하는 구조로 앞의 구간과의 효율을 비교합니다.<br>
후자가 좋다면, '8레벨 -> 9레벨'의 효율 보다 좋지 않으니 데미지적 이점 면에서는 '9레벨 -> 10레벨'라는 결과를 내놓게 되는 구조입니다.
