...
### 구현 요구사항
#### 업데이트 사항
1. 코어별 강화 횟수, 강화 종류 기능 추가.
   - 설명: 강화 횟수 측정하는 함수 횟수를 줄이고, 강화 종류는 강화 방식을 나누기 위한 장치임.

1. 강화 효율을 산출하는 함수에서 효율을 산출하는 함수로 변경.
   - 기존: 추천 레벨 달성 시 최종데미지 상승율, 100억당 최종데미지 상승율을 산출.
   - 변경: 추천 레벨 달성 시 최종데미지 상승율만 산출.
   - 설명: 기능 분리.

2. 효율을 산출하는 함수 기능 확장 및 변수명 혼란 방지.
   - 기존: 스킬 %데미지(4차 마스터리 코어, 6차 스킬 코어)
   - 변경: 스킬 계수(4차 마스터리 코어, 6차 스킬 코어), 스킬 계수 증폭(5차 강화 코어)
