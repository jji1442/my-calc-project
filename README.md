...
### 패치 내용
모든 보스 제한시간 20분화(기존 20분 ~ 60분, 대부분 30분)
'절대 심연의 속삭임' %데미지 30% 감소

### 분석 보고서 - 점유율 편
#### 개요
모든 보스 제한시간을 20분화로 인하여, '절대 심연의 속삭임'의 %데미지가 조정되어 데미지가 얼마나 하락할 지 예상해 보려고 합니다.
...
#### 분석 결과
변경 전에는 '절대 심연의 속삭임'의 9레벨 %데미지가 1,019,032%, 레벨당 %데미지 상승량이 72,788%, 점유율은 1.69% 입니다.
변경 후에는 '절대 심연의 속삭임'의 9레벨 %데미지가 716,124%, 레벨당 %데미지 상승량이 50,828% 입니다.
9레벨 기준 %데미지는 29.7250% 감소되었고, 레벨당 %데미지 상승량은 30.1698% 감소되었습니다.

#### 분석 결론
점유율은 1.69% -> 1.1936%(점유율 조정함) 되었고, 최종데미지 0.5024% 감소 되었습니다.
