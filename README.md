...
배율 20%와 500%의 차이는 25레벨까지 올라갔을 때 효율이 달라지는 것 외에는 없습니다.
배율이 1000%까지 올라가니까 효율이 레벨 구간대랑 비슷해서 그런지 레벨별로 순차적으로 강화하는 것이 효율이 좋다고 나와 있습니다.
배율이 3000% 도달 시, 데미지적 이점이 있어 16레벨 -> 20레벨 달성하는 것이 효율이 좋다고 나왔습니다.
배율이 8000% 도달 시, 데미지적 이점이 매우 커 9레벨에서 20레벨로 건너뛰는것이 효율이 좋다고 나왔습니다.
