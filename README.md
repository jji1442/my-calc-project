...
##### 1. 패치 전/후 주력 반지의 변화.
[패치 전 주력 반지]
리스트레인트 링(4레벨): 15초 동안 생성되는 영역 안에서 자신의 공격력이 80% 증가.
(재사용 대기시간 120초)
웨폰 퍼프 - S링(4레벨): 15초 동안 장착중인 주무기 공격력의 320%만큼 str증가
(재사용 대기시간 120초)

[패치 후 주력 반지]
컨티뉴어스 링(4레벨): 공격 스킬 사용 시 30초 동안 보스 몬스터 공격 시 데미지 36% 증가, 공격력 10% 증가.
(재사용 대기시간 없음)
리스트레인트 링(4레벨): 15초 동안 생성되는 영역 안에서 자신의 공격력이 "68%" 증가.
(재사용 대기시간 120초)
...
| 패치 전(평균) | 1 | 2 | 3 | 4 | 5 | 평균 |
|:---:|:---:|:---:|:---:|:---:|:---:|:---:|
| 잊혀지지 않는 흉몽VI | 13.56% | 12.90% | 13.35% | 13.35% | 12.63% | 13.154% |
| 플레인 차지드라이브VI | 6.68% | 7.44% | 7.37% | 7.69% | 8.29% | 7.494% |

| 패치 후(평균) | 1 | 2 | 3 | 4 | 5 | 평균 |
|:---:|:---:|:---:|:---:|:---:|:---:|:---:|
| 잊혀지지 않는 흉몽VI | 13.09% | 13.86% | 12.68% | 13.10% | 13.55% | 13.256% |
| 플레인 차지드라이브VI | 7.39% | 7.13% | 8.12% | 7.39% | 7.41% | 7.498% |
</details>

연계되는 스킬들의 데미지는 기존과 큰 차이가 없음을 알 수 있습니다.

#### 분석 결론
패치 전에 비해 전체 데미지가 5.49% 상승하였고, 웨폰퍼프 링과 연계되었던 스킬들의 밸류가 상대적으로 낮아졌음을 알 수 있었습니다.
