...
<h2 id="prototype-data-structure">5. 시제품 데이터 구조</h2>
...
### 기존 프로젝트 개선
문제점1: 19레벨 기준 5레벨 상승 시 평균 재화 소모량 보다 6레벨 상승 시 평균 재화 소모량이 더 낮았습니다.<br>
수정 사항: 19레벨 기준으로는 6레벨 상승 시 기준으로 측정하는 시스템을 추가하였습니다.<br>
<br>
문제점2: 9레벨, 19레벨에서 5, 6레벨 상승 시 평균 최종데미지 상승율을 측정하면 기존보다 처리속도가 더 빨라졌습니다.
수정 사항: 9레벨, 19레벨에서 5, 6레벨 상승 시 평균 최종데미지 상승율을 측정하도록 변경하였습니다.
최적화 결과: 아직 측정되지 않음
