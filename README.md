...
이 변경으로 '증오의 연쇄'를 제외한 극딜 이후, '링 익스체인지'를 통해 '웨폰퍼프 링'으로 교체하여 '증오의 연쇄'와 함께 데미지를 넣는 새로운 빌드가 등장했습니다. 이는 과거 아크의 극딜 구조와 유사한 형태를 재현합니다. 이 빌드가 가능한 핵심 이유는 '인피니티 스펠'의 사출량 증가로 인해 최대 징표까지 생성하는데 충분하기 때문입니다.

그러나 이 빌드는 개발진의 '이론과 실전의 괴리율 감소'라는 패치 기조와 상충될 가능성이 높습니다. 이 구조가 의도치 않은 '긴 극딜' 구조를 형성함에 따라, 준극딜에 전투스킬반지 변경하는 행위의 편의성을 제공하려는 개발 의도와 상충되어 후속 조정이 예상됩니다. 예상되는 조정 방안으로는 극딜 이후 연계 사용을 막기 위해 '징표 생성 확률 증가' 기능 삭제가 될 가능성이 높습니다.

한편, '영원히 굶주린 짐승'의 충돌 횟수 증가와 '끝없는 고통'의 참격 횟수 증가는 '다가오는 죽음'의 사출량을 높여, 직업 고유 재미를 돌려놓는 긍정적 효과를 가져왔습니다.

#### 분석 결론
아크의 극딜 지속시간을 30초로 압축하려고 했던 것으로 보이나, 위와 같은 새로운 빌드가 연구된 것으로 보아 깔끔하게 완성된 구조가 아닙니다.
급하게 수정한 느낌이 강하게 듭니다.
