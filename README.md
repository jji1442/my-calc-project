...
분석 및 결론: 점유율이 변동되지 않아도 간극이 생기므로, "스킬 %데미지 상승율은 1레벨에서 2레벨로 상승 시 상승율로 고정인가?"라는 가설을 세웠습니다.<br>
<br>
3.&nbsp;점유율 변동하지 않고 스킬 %데미지 상승율이 1레벨에서 2레벨로 상승 시 상승율을 또한 변동하지 않고, 최종데미지 상승율을 산출해보았습니다.<br>
