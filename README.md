...
&emsp;위 함수 세부 설계도는 프로그램의 제어 흐름을 나타내는 실선과 함수 간의 의존성을 의미하는 점선을 통해 전체 로직을 구조화했습니다.<br>
이번 알파 프로젝트로 구현된 신규 함수는 빨간색 원으로, 처리 범위가 확장된 기존 함수는 초록색 원으로, 처리 범위가 확장되었으며 최적화된 기존 함수는 보라색 원으로 표기하였습니다.

&emsp;신규로 구현된 함수들 중에서 중요한 로직을 담당하는 함수인 calc_enh_cnt_for_skill_core_list()에 대하여 설명드리겠습니다.<br>
위 함수 세부 설계도에서는 연한 갈색의 테두리로 표기하였습니다.

&emsp;calc_enh_cnt_for_skill_core_list()라는 함수는 스킬 코어 리스트(오리진 스킬, 어센트 스킬)를 위한 강화 횟수 계산하는 함수입니다.<br>
따로 계산하는 이유는 스킬 코어에 10레벨 단위로 보스에게 적용되는 데미지 증가 또는 방어율 무시 증가인 부가 효과의 효율을 측정하여 먼저 강화할 가치가 있는지 확인하기 위해섭니다.

&emsp;먼저 강화할 가치는 비용적 이점과 데미지적 이점. 이 2가지 중에서 어떠한 것이 가치가 높은지 비교하는 겁니다.<br>

&emsp;첫 부가 효과인 10레벨을 기준으로 비용적 이점의 경우에는 '10레벨 -> 11레벨'의 재화 소모량(80개)이 '9레벨 -> 10레벨'의 재화 소모량(200개)에 비해 적다는 점을 이용하여<br>
계산하였을 때, '9레벨 -> 14레벨'의 평균 재화 소모량(총 580개, 평균 레벨당 116개)이 '14레벨 -> 15레벨'의 재화 소모량(120개) 보다 적습니다.
결과적으로 비용적 이점 면에서는 '9레벨 -> 14레벨'이 가장 효율이 좋음을 알 수 있습니다.<br>

&emsp;다른 이점인 데미지적 이점으로 인해 먼저 강화할 이유가 있다면, 선제적으로 앞의 레벨과 효율을 비교하여 효율을 측정합니다.<br>
...
후자가 좋다면, 데미지적 이점에서 최종적으로 '9레벨 -> 10레벨'의 효율이 좋다는 것을 의미하기 때문에 앞의 구간과의 효율을 비교하는 행동은 무의미하므로 값을 반환합니다.

&emsp;데미지적 이점으로 인한 최종적인 결과와 비용적 이점의 비교를 통해 최종적인 스킬 레벨 강화 횟수를 산출하는 겁니다.

&emsp;자, 여기서 의문점이 하나 들겁니다. "데미지적 이점이 커서 '8레벨 -> 10레벨'의 효율이 좋다는 결과가 산출됐다면, '9레벨 -> 10레벨'의 효율에 비해 효율이 떨어지지 않나요?"<br>
그 부가 효과가 재화 소모량에 비해 효율이 좋다면 효율이 떨어질 가능성이 있습니다.<br>
다만 그 부가 효과가 좋다면, '8레벨 -> 9레벨'의 효율 보다 '8레벨 -> 10레벨'의 효율이 좋아야만 먼저 강화할 가치가 있습니다.<br>
'8레벨 -> 9레벨'의 효율 보다 효율이 안좋다면, 부가 효과로 인한 데미지 상승량의 비해 & 10레벨의 비용적 상승량에 비해 10레벨 까지 우선적으로 강화할 이유가 없다는 겁니다.
...
위 결과 이미지를 보시면, 스킬 코어 강화 코어가 추가됨을 확인하실 수 있습니다.
스킬 코어2의 20레벨의 부가 효과의 효율 보다 비용적 이점 커 19레벨 -> 25레벨을 바로 가도록 추천되었습니다.(참조 내용: 파란색 박스)
그리고 강화 코어1의 2레벨 효율이 낮음을 아실 수 있습니다.


파란색 박스는 스킬 코어2에 대한 내용, 초록색 박스는 강화 코어1에 대한 내용에 표시하였습니다.
위 결과 이미지에서 스킬 코어, 강화 코어가 추가됨을 알 수 있으며, 스킬 코어2의 20레벵의 부가 효과의 효율이 낮아, 비용적 이점이 채택되어 19레벨에서 25레벨로 추천되게 설계 되었습니다.
아크 강화 코어1의 2레벨 효율이 굉장히 낮은 모습을 확인하실 수 있습니다.
