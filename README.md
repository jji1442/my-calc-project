...
위 함수 세부 설계도는 프로그램의 제어 흐름을 나타내는 실선과 함수 간의 의존성을 의미하는 점선을 통해 전체 로직을 구조화했습니다.<br>
...
위 함수 세부 설계도에서는 연한 갈색의 테투리로 표기했습니다.

calc_enh_cnt_for_skill_core_list()라는 함수는 스킬 코어 리스트(오리진 스킬, 어센트 스킬)를 위한 강화 횟수 계산하는 함수입니다.<br>
따로 계산하는 이유는 스킬 코어에 10레벨 단위로 보스에게 적용되는 데미지 증가 또는 방어율 무시 증가인 부가 효과의 효율을 측정하여 먼저 강화할 가치가 있는지 확인한 후, 강화 횟수를 반환하는 방식입니다.

먼저 강화할 가치를 따지는 이유는 비용적 이점과 데미지적 이점. 이 2가지 중에서 어떠한 것이 가치가 높은지 비교하는 겁니다.<br>
부가 효과 10레벨을 기준으로 비용적 이점의 경우에는 10레벨 달성 시 급격하게 재화 소모량이 증가한다는 점과 '10레벨 -> 11레벨' 재화 소모량이 9레벨 -> 10레벨의 재화 소모량에 비해 적다는 점을 이용하여 계산하였을 때'9레벨 -> 14레벨'이 가장 비용적 이점이 크고.<br>
데미지적 이점으로 인해 먼저 강화할 이유가 있다면, 선제적으로 앞의 레벨과 효율을 비교하여 효율을 측정합니다.<br>
예를 들자면, '8레벨 -> 10레벨'의 효율 vs. '8레벨 -> 9레벨'의 효율.<br>
이 2가지의 수치를 비교하여 효율이 좋은 쪽을 가려내는 겁니다.<br>
전자가 좋다면 이어서, '7레벨 -> 10레벨'의 효율 vs. '7레벨 -> 8레벨'의 효율을 측정하는 구조로 앞의 구간과의 효율을 비교하는 구조입니다.<br>
후자가 좋다면, 데미지적 이점에서 최종적으로 '9레벨 -> 10레벨'의 효율이 좋다는 것을 의미하기 때문에 앞의 구간과의 효율을 비교하는 반복은 무의미하므로 값을 반환합니다.

데미지적 이점으로 인한 최종적인 결과와 비용적 이점의 비교를 통해 최종적인 스킬 레벨 강화 횟수를 산출하는 겁니다.

자, 여기서 의문점이 하나 들겁니다. "데미지적 이점이 커서 '8레벨 -> 10레벨'의 효율이 좋다는 결과가 산출됐다면, '9레벨 -> 10레벨'의 효율에 비해 효율이 떨어지지 않나요?"<br>
그 부가 효과가 재화 소모량에 비해 효율이 좋다면 효율이 떨어질 가능성이 있습니다.<br>
다만 그 부가 효과가 효율이 좋다면, '8레벨 -> 9레벨'의 효율 보다 '8레벨 -> 10레벨'의 효율이 좋아야만 먼저 강화할 가치가 있습니다.<br>
'8레벨 -> 9레벨'의 효율 보다 효율이 안좋다면, 이 스킬 %데미지 상승량의 비해 & 비용적 상승량에 비해 10레벨 까지 강화할 이유가 없다는 겁니다.

"이 효율이 떨어진 상태로 데미지적 이점과 비용적 이점의 비교를 하면 우선 순위에서 밀리는 것 아닌가요?"라는 질문을 하나 더 던지게 될 겁니다.<br>
하지만 '8레벨 -> 9레벨'의 효율이 '10레벨 -> 11레벨'의 효율보다 항상 좋다는 점을 이해한다면 이 질문은 자연스럽게 해결됩니다.<br>
스킬 레벨이 올라갈수록 현재 스킬 %데미지양이 늘어나고, 고정적인 스킬 %데미지 상승에 대한 이점은 점차 줄어들게 됩니다.<br>
스킬 레벨이 올라갈수록 또한 현재 재화 소모량이 증가하며 재화 효율에 대한 이점도 점차 감소되므로, 비용적 이점에 비해 데미지적 이점에서 이전 레벨과의 비교는 유효함을 의미합니다.<br>
여기서 비용적 이점은 추천 레벨 구간 내에서 재화 소모량 대비 효율이 가장 높은 구간을 선정하였다는 점을 전제로 비교합니다.

다시 돌아와서, 데미지적 이점과 비용적 이점의 효율을 비교합니다.

두 이점 중에 효율이 좋은 쪽 하나가 선택될 것이고. 이 과정을 20레벨 및 30레벨 기준으로 2번 더 반복합니다.

그리고 산출된 추천 레벨들을 정렬합니다.<br>
이 추천 레벨이 서로 겹치는 구간이 있을 가능성(부가 효과의 효율이 좋은 경우)이 있습니다.<br>
그럴 경우에는 두 레벨 구간 간의 효율을 비교합니다.<br>
그 중 더 높은 효율을 기준으로 추천 레벨을 정렬합니다.<br>
예를 들어, '19레벨 -> 25레벨'과 '24레벨 -> 30레벨'이 선정되었다고 가정하면 위 2가지의 효율을 비교하여<br>
전자가 좋다면, 최종적으로 추천 레벨을 '19레벨 -> 25레벨 -> 30레벨'<br>
...
그리고, 각 추천 레벨 구간 별로 if문을 만든 대신 레벨이 높은 구간 순으로 강화 횟수를 산출하도록 if문을 설계하여 겹치는 가능성에 의해 강화 레벨 추천 순서가 변하지 않도록 설계하였습니다.
