...
##### 후기 내용
아크가 본 서버에 업데이트 된 지 4주차 기준으로 이 패치에 대한 평가는 게임사에서 "전투경험개선"이라는 명목 하에 패치하였으나, 실제 체감은 "전투경험개악"에 가까웠습니다.
...
'돌아오는 증오'의 기능 변화는 '세렌(보스)', '카링(보스)' 3페이즈에서는 좋았습니다. 맵 중앙에서 전투 시 '세렌'이 돌진 스킬을 사용하면 쌓아놓은 '징표'들을 맞출 방법이 없었습니다. 이로 인해 '세렌'을 유도하는 컨트롤(맵 바깥쪽으로 유인하는 행동)이 필수적이었습니다.(이 컨트롤을 했을 때/하지 않았을 때 데미지가 10% 이상 차이남.) 패치 이후에는 보스를 유도할 필요가 없어져 입장 후 '세렌'의 돌진을 기다릴 필요가 없다는 점과 '세렌'을 맵 바깥쪽으로 유도할 필요가 없다는 점이 마음에 들었습니다. '카링' 3페이즈는 '블링크' 활용하여 최대 4명에게 적중할 수 있게 되었습니다.(기존 3명)
