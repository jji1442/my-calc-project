...
다음 패치에선 '증오의 연쇄'라는 스킬만 삭제하고, 스펙터 연계 스킬들의 %데미지를 전체적으로 10% ~ 15% 가량 올려주었으면 좋겠습니다. 왜냐하면 '인피니티 스펠' 없이 '증오의 연쇄'만 사용하여 최대 징표를 쌓기란 쉽지 않기 때문에 스펙터 자체의 체급을 올려주었으면 합니다. 하지만 이런 식으로 해결할 경우 '돌아오는 증오'의 점유율이 상당히 떨어지겠지만, 적중율이 낮은 스킬은 점유율 또한 낮아야한다고 생각합니다.
