...
'매서풀' 스킬 %데미지 * 사용횟수 + '다가오는 죽음' 스킬 %데미지 * 사용횟수 = '매서풀'로 인한 총 %데미지.<br>
1100 * 3 * 47.6 + ((450 + 54 + 112) * 2 * 121.4) * 2.2 = 486,122.56(48만 6122.56%)<br>

'매서풀 VI' 스킬 %데미지 * 사용횟수 = '매서풀 VI' 1레벨 스킬 %데미지.<br>
...
공격력 상승치에 따른 최종데미지를 고려하더라도 '매서풀 VI' 6레벨에서야 비로소 기존 성능과 비슷해질 것으로 예상됩니다.
