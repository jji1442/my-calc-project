...
4. 분석 보고서 - 점유율 편<br>
  ...
  <b><<분석 방법>></b><br>
  분석 종류<br>
  &emsp;1. 패치 '전' 55초 스펙터 / 55초 레프 구조 + 허수아비형 보스 기준 링 익스체인지 '있이' 6분 주기.
  &emsp;2. 패치 '후' 55초 스펙터 / 55초 레프 구조 + 허수아비형 보스 기준 링 익스체인지 '있이' 6분 주기.
  &emsp;3. 패치 '후' 35초 스펙터 / 20초 레프 / 25초 스펙터 / 30초 레프 구조 + 허수아비형 보스 기준 링 익스체인지 '있이' 6분 주기.
  분석 전제조건<br>
...
| 평균 | 조 억 | 조 억 | 301조 5426억 |
  ...
  위의 표를 보아, 2번과 3번의 데미지 차이가 % 나는 것으로 보아, 패치 이후에는 3번 구조를 필히 사용해야합니다. 3번의 데미지는 1번의 데미지 보다 1.08% 높다는 것을 알 수 있습니다.
  다음으로, 1번과 3번의 스킬 점유율 비교입니다.
