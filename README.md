...
#### 분석 결론
0레벨과 9레벨 간의 실측 데이터가 100억 메소당 최종데미지 1.6518% 상승한다는 점, 환산주스탯에서 나오는 14레벨의 100억당 최종데미지 1.714%를 고려했을 때, 14레벨 달성 가치가 있다고 생각합니다.
...
#### 분석 결과
변경 전에는 '절대 심연의 속삭임'의 9레벨 %데미지가 1,019,032%, 레벨당 %데미지 상승량이 72,788%, 점유율은 1.69% 입니다.<br>
변경 후에는 '절대 심연의 속삭임'의 9레벨 %데미지가 716,124%, 레벨당 %데미지 상승량이 50,828% 입니다.<br>
