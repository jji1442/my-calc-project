...
4. 강화 효율 산출하는 함수 추가.
   ...
   - 설명: 효율을 산출하는 함수 및 부가 효과의 효율을 산출하는 함수에서 산출된 최종데미지 상승율을 이용하여 100억당 최종데미지 상승율을 산출. 

5. 코어 추천해주는 함수 기능 확장.

6. 부가 효과에 따른 스탯 상승을 처리해주는 함수 추가.
