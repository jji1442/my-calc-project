...
25.07.17. 메이플스토리에 어센트 스킬이 추가되었습니다. 어센트 스킬은 보스 전투 환경에서 쿨타임 없이 최대 3회까지 연속 사용이 가능하도록 설계되었습니다.<br>
이 점을 이용하여 환산주스탯에서 어센트 스킬의 강화효율 측정 기준을 오리진 스킬 횟수 기준으로 개발되었습니다.<br>
환산주스탯에서 오리진 스킬 1회 사용 기준으로 확인해본 결과, 어센트 스킬의 강화순서가 2레벨에서 9레벨까지 연속적으로 강화하였을 때 효율적인 구조이었고 위 가설에 추가 테스트를 진행해 보았습니다.<br>
<br>
