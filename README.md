...
3. 변수 사용량이 줄여 RAM 사용량 개선.
   - 기존: 1, 5레벨 상승 시 (평균) 최종데미지 상승율, 100억당 (평균) 최종데미지 상승율을 측정.
   - 변경: 레벨 상승 시 (평균) 최종데미지 상승율, 100억당 (평균) 최종데미지 상승율을 측정.
   - 설명: RAM 사용량을 줄이기 위해서 개선.

4. 일부 계산 개선.
   - 기존: 5, 6레벨 상승 시 평균값을 기준으로 도출하여 사용.
   - 변경: 5, 6레벨 상승 시 총 상승량을 도출하여 사용.
   - 설명: 이 평균값을 기준으로 데미지 상승율을 도출하다보니, 가장 큰 문제점인
