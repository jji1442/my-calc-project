...
2. 6분 주기 측정에 적합하지 않은 스킬인 스파이더 인 미러, 크레스트 오브 더 솔라(쿨타임 4분) 제외.
3. 허수아비형 보스에선 효용 가치가 없는 일리움 링크 제외.
4. 서버렉으로 인하여 데미지 편차가 심한 일격필살 제외.
5. 실전성 없으며, 돌아오는 증오 생성량 편차가 심한 60초 쿨타임인 '끝없는 고통VI' 스킬 미사용.
6. 메르세데스 유니온 효과(스킬 쿨타임 6% 감소)를 적용하여 오리진 스킬(360초)의 실제 쿨타임은 338.4초.<br>
&emsp;&emsp;측정 기준을 소수점 첫 번째 자리에서 반올림하여 5분38초(338초)로 설정.<br>
     >&nbsp;대부분의 유저들이 메르세데스 유니온 효과를 가지고 있지만, 스킬 쿨타임 감소 효과를 지닌 모자는 비교적 소수의 유저들이 사용하므로 제외하고 측정.
7. 특수한 경우가 아닌 보편적인 경우를 기준으로 측정.<br>
     >&nbsp;ex) 개발자의 아크는 스킬 쿨타임 2초 감소인 모자를 착용 중.<br>
     >&nbsp;338초 기준으로 측정 시, 4회차 쿨타임 2분인 버프 및 스킬을 6초 가량 사용할 수 있으니 쿨타임 2분인 스킬은 3회로 제한.
8. 어센트 스킬은 시간 내에 가장 데미지 손해가 적은 구간에서 1회 사용.
9. 개발자 기준 모든 도핑 사용. 필드는 어센틱 포스 요구치 1. 보스는 레벨 250, 방어율 380%, 체력 무한, 대형, 반감 기준으로 측정.
...
링 익스체인지 사용으로 인한 딜 상승량은 @%이며,
이로 인한 아크의 스킬별 점유율 변화는 다음과 같습니다.

1. 링 익스체인지에 영향이 미치는 스킬들 - 다가오는 죽음, 깨어난 심연, 돌아오는 증오VI, 잊혀지지 않는 흉몽VI.
2. 링 익스체인지에 영향이 미치지 않는 스킬들 - 영원히 굶주리는 짐승, 근원의 기억, 끝없는 고통VI.

| 스킬 이름 | 링 익스체인지 미사용 | 링 익스체인지 사용 |
|:---:|:---:|:---:|
| 다가오는 죽음 | 26.89% |  |
| 깨어난 심연 | 11.98% |  |
| 돌아오는 증오VI | 11.91% |  |
