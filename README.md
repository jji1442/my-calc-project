...
'매서풀'로 인한 총 %데미지 = '매서풀' 스킬 %데미지 + '다가오는 죽음' 스킬 %데미지.<br>
...
#### 분석 결론
핵심 스킬을 다 만렙(30레벨) 찍었고, 나머지 효용감 없는 스킬들의 헥사 강화할 때, 그나마 효용감 있는 이 '매서풀 VI'를 강화하는 것을 권장한다.
'매서풀 VI'를 강화하는 경우에도 12레벨 이상 달성할 수 있는 충분한 재화를 모아두고 스킬을 강화하는 것을 권장한다.
