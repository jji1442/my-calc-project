...
25.08.21 기준 게임사는 전투 경험 개선 목적으로 아크는 '링 익스체인지' 스킬과 '최종데미지 6% 증가' 패시브를 받았습니다.<br>
<br>
<변화된 강화 효율에 대한 평가><br>
'링 익스체인지'로 인한 코어 강화 효율 변화를 보려고 합니다.<br>
'최종 데미지 6% 증가' 패시브의 경우 모든 스킬에 동일하게 적용되는 상시 증가 효과이므로, 스킬 간의 상대적인 효율을 측정하는 데에는 영향이 없습니다.<br>
<br>
'특수 스킬 반지'란?<br>
...
기존 점유율이 다소 다를 수 있습니다.
(잊혀지지 않는 악몽VI/잊혀지지 않는 흉몽VI/다가오는 죽음의 코어가 기존 9레벨에서 15레벨로 변경되었습니다.)
...
<패치에 대한 평가><br>
25.08.21. 전투 경험 개선을 패치한 이유는 '최초의 대적자(이하 신규 보스)'에 의해 패치된 것으로 추정됩니다.<br>
<br>
패치 이전, 제 아크는 허수아비형 보스에게 2분 주기 기준 피해량 66조, 오리진 스킬 포함하여 2분 주기 기준 피해량 81조를 기록했습니다.<br>
하지만 패치 이후, 신규 보스에서 '링 익스체인지' 사용하여 측정된 딜량은 패치 이전 두 딜량의 90% 수준을 기록했습니다.<br>
<br>
...
1. 링 익스체인지 '없이' 오리진 포함한 2분 사이클 + 2분 사이클 (최종데미지 6% 증가를 제외하여 계산)
2. 최초의 대적자 링 익스 체인지 '있이' 오리진을 포함한 2분 사이클 + 2분 사이클.
