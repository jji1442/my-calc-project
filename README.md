...
3. '기어다니는 공포(키다운 무적기)' 시전 중 체력 감소 현상 삭제 및 공격 가능하게 변경.
  - 키다운 중 체력이 감소하는 리스크를 가진 대신 최대 5초간 무적이 가능하다는게 장점이 있지만, 스킬 키다운 중 공격을 못합니다.
...
이 데이터는 특정 스킬의 비중을 줄이고 다른 스킬들의 효율을 높여 강화 효율을 개선하려는 개임사의 의도를 명확하게 보여줍니다.
