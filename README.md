...
2. 사용자의 강화 효율과 불일치.<br>
  - 사용자의 전투 방식이 제공된 가이드라인과 다른 경우, 실제 강화 효율에 큰 차이가 발생할 수 있습니다.<br>
3. 개인별 최적화의 부재.<br>
  - 개인별 '스킬 쿨타임 감소'나 '특수 스킬 반지' 같은 변수를 반영하지 못합니다.<br>
4. 고정된 강화 순서 제공.<br>
  - 헥사 코어 레벨에 따라 달라지는 강화 효율을 고려하지 않고 고정된 강화 순서 및 강화 효율만을 제공합니다.<br>
