...
&emsp;먼저 강화할 가치를 따지는 이유는 비용적 이점과 데미지적 이점. 이 2가지 중에서 어떠한 것이 가치가 높은지 비교하는 겁니다.<br>
부가 효과 10레벨을 기준으로 비용적 이점의 경우에는 10레벨 달성 시 급격하게 재화 소모량이 증가한다는 점과 '10레벨 -> 11레벨' 재화 소모량이 9레벨 -> 10레벨의 재화 소모량에 비해 적다는 점을 이용하여<br>
계산하였을 때'9레벨 -> 14레벨'이 가장 비용적 이점이 크고.<br>
