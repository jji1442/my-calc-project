...
[12. 패치 분석 보고서(26.06.18)](#patch_analysis_report_26.06.18)<br>
...
<details>
<summary> 패치 전 55:55 빌드 분석 결과 확인하기(펼치기/닫기)</summary>
...
<details>
<summary> 패치 후 55:55 빌드 분석 결과 확인하기(펼치기/닫기)</summary>
...
<img src="post_patch_legacy_build_img/3/post_patch_legacy_build_3_6.PNG">
</details>

<details>
<summary> 패치 후 58:52 빌드 분석 결과 확인하기(펼치기/닫기)</summary>
...
<img src="post_patch_new_build_img/3/post_patch_new_build_3_6.PNG">
</details>
...
1차적으로 전투경험 면에서는 쾌적함을 느꼈습니다. 35초 가량의 극딜을 넣고, 이어서 남은 극딜 버프와 함께 스펙터 연계스킬을 사용해도 되고 아니면 준극딜 버프 쿨타임이 돌은 이후에 스펙터 연계스킬을 사용해도 되기 때문에 자율성 면에서 좋았습니다.

그리고, "근원의 기억"을 비교적 자유롭게 사용할 수 있어 굉장히 만족스럽습니다.
...
"사실인지 불명확한 사항이며 체감적인 요소로만 작성된 내용입니다."<br>
'돌아오는 증오'의 판정이 피격 범위에서 시전한 시점으로 기준이 변경된 느낌이 듭니다. 또는 판정 시간이 후해졌다거나. 8월달에는 '칼로스(보스)'의 2페이즈에서 보스가 텔레포트를 사용했을 때 종종 빗나가는 모습을 보였는데, 10월달 패치 이후에는 빗나가는 현상이 적어진 느낌이 듭니다. 이 현상이 보스를 상대하는 숙련도가 올랐을 가능성이 있고, 스킬 사용횟수가 줄어 더 잘 사용하려고 노력하여 적중율이 올랐을 가능성도 있습니다.

준극딜 삭제로 인한 극딜 압축이 체감이 컸습니다.

실전 데미지 부분에서 큰 체감을 한 부분이 '칼로스(보스)' 2페이즈입니다. 눈금 1칸을 파티원과 같이 오리진 스킬을 포함하여 극딜을 넣으면, 30초 만에 다음 눈금이 열렸습니다. 물론 스펙적으로 성장한 부분이 있다는 점을 감안하더라도 체감이 될 정도로 강해졌습니다. 이전의 패치(스펙터 연계스킬 데미지 상승)로 인해 보스 체력이 애매한 경우, 스펙터 연계스킬을 사용하여 다음 페이즈로 넘어갈 수 있다는 점이 굉장히 좋았습니다.

실전 데미지가 체감상 10 ~ 12%가 상승한 것으로 예상됩니다.
...
#### 주관적인 평가
주변인이 "그래서 '매서풀VI'을 몇 레벨까지 찍어야 효율이 나오냐?"라고 물어보신다면, 저는 환산주스탯 기준 '매서풀VI' 14레벨부터 강화하는 시점을 적극 추천합니다. 이 시점부터 투자비용 대비 스킬 %데미지의 손해를 최소화하는 동시에 스킬 레벨업에 따른 데미지적 이점을 기대할 수 있기 때문입니다.

#### 추가 테스트
세 레벨 간 '매서풀VI'의 차이를 측정해보겠습니다.
<table>
  <thead>
    <tr>
      <th align="center">시행 횟수 \ 분석 종류</th>
...
'매서풀VI' 0레벨은 1레벨 보다 3조 0451억 높지만(+0.5671%), 9레벨 보다 2조 6697억 낮다(-0.4972%)는 점을 알 수 있습니다.<br>

'매서풀VI' 0 -> 1레벨의 가치를 구해보자면,
1레벨 달성하는데 필요한 재화 개수는 90개고, 재화 가치는 개당 700만 메소입니다. 재화비용은 총 6.3억 메소입니다.<br>
100억 메소당 최종데미지 상승율을 구하면, -0.5671 * (100 / 6.3) = -9.0016<br>
100억 메소당 최종데미지 9.0016% "하락"한다는 점을 알 수 있습니다.<br>

9레벨 달성하는데 필요한 재화 개수는 총 430개(0 -> 9레벨)고, 재화 가치는 개당 700만 메소입니다. 재화 비용은 총 30.1억 메소입니다.<br>
100억 메소당 최종데미지 상승율을 구하면, 0.4972 * (100 / 30.1) = 1.6518<br>
100억 메소당 최종데미지 1.6518% 상승한다는 점을 알 수 있습니다.<br>

"이 부분은 약식으로 효율을 계산하였습니다."<br>
이어서, '매서풀VI' 8 -> 9레벨의 가치를 구해보자면,<br>
1 -> 9레벨의 총 상승치 1.0704%이고, 상승 레벨 수치는 8레벨. 따라서, 1레벨당 최종데미지 상승치는 0.1338%.<br>
8 -> 9레벨의 재화 개수는 60개, 재화 가치는 700만 메소. 재화 비용은 총 4.2억 메소입니다.<br>
100억 메소당 최종데미지 상승율을 구하면, 0.1338 * (100 / 4.2) = 3.1857<br>
100억 메소당 최종데미지 3.1857% 상승한다는 점을 알 수 있습니다.

"이 부분은 약식으로 효율을 계산하였습니다."<br>
위 수치를 토대로, 9레벨 -> 14레벨까지 레벨당 최종데미지 상승치가 모든 구간 동일하게 오른다고 가정했을 때,<br>
9 -> 14레벨의 총 상승치는 0.6690%.<br>
14레벨 달성하는데 재화 개수는 총 522개(9 -> 14레벨), 재화 가치는 700만 메소, 재화 비용은 총 36.54억 메소입니다.<br>
100억 메소당 최종데미지 상승율을 구하면, 0.669 * (100 / 36.54) = 1.8309<br>
100억 메소당 최종데미지 1.8309% 상승한다는 점을 알 수 있습니다.

"이 부분은 약식으로 효율을 계산하였습니다."<br>
위 수치를 토대로,<br>
0 -> 14레벨의 총 상승치는 1.1662%(= 0.4972 + 0.6690).<br>
14레벨 달성하는데 재화 개수는 총 952개(0 -> 14레벨), 재화 가치는 700만 메소, 재화 비용은 총 66.64억 메소입니다.<br>
100억 메소당 최종데미지 상승율을 구하면, 1.1662 * (100 / 66.64) = 1.7500<br>
100억 메소당 최종데미지 1.7500% 상승한다는 점을 알 수 있습니다.
...
0 -> 9레벨의 가치보다 0 -> 14레벨의 가치가 더 높다는 것을 통해, 부가효과 변경으로 인한 데미지 하락이 14레벨이 되어도 영향을 미치고 있다는 점을 알 수 있습니다.<br>
14 ~ 19레벨 구간이 변곡점으로 작용될 것으로 추정되며, 100억 메소당 최종데미지 수치는 1.4324%로 추정됩니다.<br>
(1.75 + (1.8309 - 1.75) * 0.5) * 0.8 = 1.4324 (0.8는 모든 구간 동일하게 상승을 보정하는 값)

개발자의 캐릭터가 강화를 진행하고 있는 구간의 효율이 100억 메소당 최종데미지 2.343% 상승한다는 점을 고려했을 때, 0 -> 9레벨의 가치는 좋지 못한다는 점을 실측 데이터를 통해 알 수 있습니다.

<br><br><br>

<h2 id="patch_analysis_report_26.06.18">12. 패치 분석 보고서(26.06.18)</h2>

### 작성 기간
26.06.20 ~ 26.06.20

### 패치 내용
1. 모든 보스 제한시간 20분으로 변경(기존 20분 ~ 60분, 대부분 30분)<br>
2. '절대 심연의 속삭임' %데미지 30% 감소

### 분석 보고서 - 어센트 스킬 편
#### 개요
모든 보스 제한시간을 20분으로 변경되어 '절대 심연의 속삭임'의 %데미지가 조정되었고, 이로 인하여 데미지가 얼마나 하락할 지 "예측"해 보려고 합니다.<br>
※ '절대 심연의 속삭임'은 어센트 스킬로, 보스 입장 후 최대 3회 공격할 수 있는 스킬입니다.

#### 분석 방법
변경 전후의 스킬 %데미지 수치와 실전 데이터를 이용하여 결과 도출.

#### 분석 결과
변경 전에는 '절대 심연의 속삭임'의 9레벨 %데미지가 1,019,032%, 레벨당 %데미지 상승량이 72,788%p, 점유율은 1.69% 입니다.<br>
변경 후에는 '절대 심연의 속삭임'의 9레벨 %데미지가 716,124%, 레벨당 %데미지 상승량이 50,828%p 입니다.<br>
9레벨 기준 %데미지는 29.7250% 감소되었고, 레벨당 %데미지 상승량은 30.1698% 감소되었습니다.

#### 분석 결론
최종데미지 0.5024% 감소되었고, 점유율은 1.69% -> 1.1936%(백분율 조정함) 되었습니다.
