...
= 매서풀VI 1레벨 스킬 자체가 입힌 누적 데미지 * 스킬 %데미지 상승율<br>
= 5조 1859억 * 64.865%<br>
= 3조 3638억
...
추가 효과로 인한 누적 데미지 상승치
= 공격력 상승으로 인한 '매서풀VI' 9레벨 스킬 자체가 입힌 누적 데미지의 상승치 + 공격력 상승으로 인한 '매서풀VI' 스킬을 제외한 나머지 스킬로 입힌 누적 데미지의 상승치
= 422억 + 2조 3904억
= 2조 4326억
