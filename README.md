...
14레벨 달성하는데 재화 개수는 총 443개(9 -> 14레벨), 재화 가치는 700만 메소, 재화 비용은 총 30.31억 메소입니다.<br>
100억 메소당 최종데미지 상승율을 구하면, 0.669 * (100 / 30.31) = 2.2072<br>
100억 메소당 최종데미지 2.2072% 상승한다는 점을 알 수 있습니다.

"이 부분은 약식으로 효율을 계산하였습니다."<br>
위 수치를 토대로,<br>
0 -> 14레벨의 총 상승치는 1.1662%(= 0.4972 + 0.6690).<br>
14레벨 달성하는데 재화 개수는 총 873개(0 -> 14레벨), 재화 가치는 700만 메소, 재화 비용은 총 61.11억 메소입니다.<br>
100억 메소당 최종데미지 상승율을 구하면, 1.1662 * (100 / 61.11) = 1.9084<br>
100억 메소당 최종데미지 1.9084% 상승한다는 점을 알 수 있습니다.

#### 추가 테스트 분석 결론
0 -> 9레벨: 100억 메소당 최종데미지 1.6518% 상승.<br>
8 -> 9레벨: 100억 메소당 최종데미지 3.1857% 상승.<br>
9 -> 14레벨: 100억 메소당 최종데미지 2.2072% 상승.<br>
0 -> 14레벨: 100억 메소당 최종데미지 1.9084% 상승.

0 -> 9레벨의 가치보다 0 -> 14레벨의 가치가 더 높다는 것을 통해, 부가효과 변경으로 인한 데미지 하락이 14레벨이 되어도 영향을 미치고 있다는 점을 알 수 있습니다.<br>
14 ~ 19레벨 구간이 변곡점으로 작용될 것으로 추정되며, 100억 메소당 최종데미지 수치는 1.95%로 추정됩니다.
...
### 패치 내용
1. 모든 보스 제한시간 20분화(기존 20분 ~ 60분, 대부분 30분)<br>
2. '절대 심연의 속삭임' %데미지 30% 감소

### 분석 보고서 - 어센트 스킬 편
#### 개요
모든 보스 제한시간을 20분화되어, '절대 심연의 속삭임'의 %데미지가 조정되었고, 이로 인하여 데미지가 얼마나 하락할 지 "예상"해 보려고 합니다.<br>
...
#### 분석 결론
점유율은 1.69% -> 1.1936%(점유율 조정함) 되었고, 최종데미지 0.5024% 감소되었습니다.
