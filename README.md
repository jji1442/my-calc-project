...
이 스킬들이 비정상적(두 스킬 점유율이 2.6 ~ 2.7배 상승됨)으로 수치가 높은 것이 문제입니다.
이렇게 되면 '스킬 쿨타임 감소' 모자 + '확률에 따른 일부 스킬 쿨타임 초기화' 어빌리티를 강제하게 됩니다.
...
아크는 다가오는 죽음 사출되는 재미 + 높은 기동성 2개가 재밌어서 하는거였늗네
그 중 다가오는 죽음 사출되는 재미 하나가 반감되니 할 생각이 들지 않는ㄱ누요
