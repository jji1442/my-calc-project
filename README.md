...
설명: 다양한 코어의 효율을 정확하게 측정하기 위해 함수 기능 확장. 기존 네이밍인 코어별 최종데미지 증가와 충돌되지 않도록 강화 코어의 최종데미지 증가는 스킬 계수 증폭으로 변경. 기존의 스킬 %데미지는 스킬 계수로 명칭을 통일.

4. 부가 효과 효율 산출하는 함수 추가.
기능: 해당 스킬에만 적용되는 스탯% 상승하는 효과(6차 스킬 코어 패시브), 직업별 부가효과를 산출.
설명: 
