...
아래의 예시는 오리진 스킬 코어는 9레벨, 나머지 코어는 30레벨로 설정하고 20레벨 부가 효과인 보스에게 적용되는 데미지 증가의 배율을 3000%로 조정하여 부가 효과의 효율이 높게 설정하였습니다.
...
&emsp; 이미지1은 비용적 측면에서 '19레벨 -> 20레벨'이 선택되어 20레벨의 달성 가치를 '단일 레벨'로만 판단하여 19레벨 이하 구간 효율에 의해 20레벨 추천 순위가 뒤로 밀려버리는 논리적 오류가 생깁니다.<br>
이미지2는 강화 단계의 논리적 선후 관계를 유지하여, 유저가 최종적으로 20레벨이라는 목표에 합리적으로 도달할 수 있도록 강화 경로를 매끄럽게 연결한 결과입니다.
...
배율 20% 및 500% 에서는 부가 효과에 대한 이점보다 비용적 이점이 더 크게 작용하는 양상을 보였으며, 이로 인해 20레벨을 빠르게 달성하기보다는 강화를 후순위로 강화하는 것이 효율이 좋다라는 결과가 도출되었습니다.<br>
반면 배율 800% 수준에 도달 시, 부가 효과에 대한 이점과 비용적 이점이 동일한 구간에 도달하여, 모든 단계를 순차적으로 강화하는 방식이 최적의 선택으로 나타났습니다.<br>
이후 배율 3000% 에서는 부가 효과에 대한 이점이 비용적 이점을 명확히 상회하며, 20레벨을 빠르게 달성하는 것이 가장 효율적인 결과를 보였습니다.<br>
결과적으로 부과 효과에 대한 이점이 더 커지려는 시점이 대략 배율 800% 기점으로 효율이 뒤바뀐다는 점을 알 수 있으며, 위 함수는 정상적으로 처리되고 있음을 알 수 있습니다.
