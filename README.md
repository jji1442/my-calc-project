...
<br>
하지만, 메이플스토리에 코어들이 추가되면서 하나의 코어를 연속적으로 강화하는 것 보다, 다른 코어 또한 강화해야 효율이 좋게  효율 좋은 구간이어야하며 '선참VI'과 유사한 단순한 코어를 찾기 어려워 한동안 시행착오를 중지하였습니다.<br>
<br>
이후 메이플스토리에 어센트 스킬이 추가되었고. 어센트 스킬은 쿨타임과 관계 없이 스킬을 한 보스에서 최대 3번을 연속으로 사용 가능하다는 점을 이용하여, 보스 클리어 타임이 6분을 기준으로 효율 계산하였을 때 연속적으로 강화(2 -> 9레벨)하는 것이 효율이 좋다는 환산주스탯의 효율을 보고 다시 효율을 측정해보았습니다.<br>
<br>
