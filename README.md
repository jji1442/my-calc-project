...
&emsp; 이미지1은 비용적 측면에서 '19레벨 -> 20레벨'이 선택되어 20레벨의 달성 가치를 '단일 레벨'로만 판단하여 19레벨 이하 구간의 효율에 의해 20레벨 추천 순위가 뒤로 밀려버리는 논리적 오류가 생깁니다.<br>
...
&emsp;배율 20% 및 500% 에서는 부가 효과에 대한 이점보다 비용적 이점이 더 크게 작용하는 양상을 보였으며, 이로 인해 20레벨을 빠르게 달성하기보다는 강화를 후순위로 강화하는 것이 효율이 좋다라는 결과가 도출되었습니다.<br>
...
### 알파 사용 방법
1. 프로그램 실행을 위해 python 환경이 필요합니다.
2. 알파를 다운로드합니다. [>> 알파 프로젝트 다운로드 하기(추가 예정)](https://github.com/jji1442/my-calc-project/releases/download/ver.1.0/test_model.zip)
