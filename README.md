...
- 정의한 함수.
  - 강화효율을 산출하는 함수.
    - 매개변수로 스킬 재화효율, 점유율, 스킬 데미지 상승율임.
    - 최종데미지 상승율은 점유율 * 스킬 데미지 상승율임.
    - 100억당 최종데미지 상승율은 재화 효율 * 점유율 * 스킬 데미지 상승율임.
    - 리턴값은 최종데미지 상승율, 100억당 최종데미지 상승율임.
  ...
  - 1레벨 상승 시 강화효율을 산출하는 함수.
    ...
    - for i in 마스터리 코어[스킬].items(): 형식을 사용하여, 모든 스킬을 시행함.
      - 스킬 데미지 상승량은 1레벨 상승 시 %데미지 상승량(%p) / 현재 레벨 기준 %데미지임.
      - 1레벨 상승 시 최종데미지 상승율, 1레벨 상승 시 100억당 최종데미지 상승율 = 강화효율을 산출하는 함수(재화 효율, 마스터리 코어[스킬][점유율], 마스터리 코어[스킬][점유율])
  ...
  - 5레벨 상승 시 강화효율 체크하는 함수.
    ...
    - for i in 마스터리 코어[스킬].items() 형식을 사용하여, 모든 스킬을 시행함.
      - 평균 스킬 데미지 상승량은 (1레벨 상승 시 %데미지 상승량(%p) / 현재 레벨 기준 %데미지 + 1레벨 상승 시 %데미지 상승량(%p) / (현재 레벨 기준 %데미지 + 1레벨 상승 시 %데미지 상승량(%p)) + 1레벨 상승 시 %데미지 상승량(%p) / (현재 레벨 기준 %데미지 + 2 * 1레벨 상승 시 %데미지 상승량(%p)) + 1레벨 상승 시 %데미지 상승량(%p) / (현재 레벨 기준 %데미지 + 3 * 1레벨 상승 시 %데미지 상승량(%p)) + 1레벨 상승 시 %데미지 상승량(%p) / (현재 레벨 기준 %데미지 + 4 * 1레벨 상승 시 %데미지 상승량(%p))) / 5임.
        - 평균 스킬 데미지 상승량은 (이 스킬을 5레벨 연속으로 강화했을 시의 데미지 합산 수치) / 5 임.
      - 5레벨 상승 시 평균 최종데미지 상승율, 5레벨 상승 시 100억당 평균 최종데미지 상승율 = 강화효율을 산출하는 함수(재화 효율, 마스터리 코어[스킬][점유율], 마스터리 코어[스킬][점유율])
