...
<br>
1-1.&nbsp;기존 엑셀에 보정 상수(1레벨당 0.01% 감소)를 추가해 보았습니다.
...
<br>
2.&nbsp;'점유율(변동하지 않음) * 스킬 %데미지 상승율'로 최종데미지 상승율을 산출해보았습니다.
...
<br>
3.&nbsp;점유율을 고정하고, 스킬 %데미지 상승율 또한 1레벨에서 2레벨로 상승 시 상승율로 고정하여 최종데미지 상승율을 산출해보았습니다.
