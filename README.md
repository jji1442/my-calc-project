...
그러면 제작하는데 있어 필요한 요소들은 무엇인가? 이러한 기능들이 필요로 할 것이다.
이러한 기능을 구현하는데 무엇이 필요하는가? 이러한 것들이 필요하다.
...
메인 함수
	강화횟수를 측정하는 함수(스킬 코어 리스트)
	강화횟수를 측정하는 함수(강화 코어 리스트)
	강화횟수를 측정하는 함수(마스터리 코어 리스트)
