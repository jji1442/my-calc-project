...
- 정의한 함수.
  ...
  - 1레벨 상승 시 강화효율을 산출하는 함수.
    ...
    - 재화 소모량 = 마스터리 코어 1~30레벨 리스트[마스터리 코어[현재 레벨]]
  ...
  - 5레벨 상승 시 강화효율 체크하는 함수.
    ...
    - for i in 마스터리 코어[스킬].items():
      - 평균 스킬 데미지 상승율은 (1레벨 상승 시 %데미지 상승량(%p) / 현재 레벨 기준 %데미지 + 1레벨 상승 시 %데미지 상승량(%p) / (현재 레벨 기준 %데미지 + 1레벨 상승 시 %데미지 상승량(%p)) + 1레벨 상승 시 %데미지 상승량(%p) / (현재 레벨 기준 %데미지 + 2 * 1레벨 상승 시 %데미지 상승량(%p)) + 1레벨 상승 시 %데미지 상승량(%p) / (현재 레벨 기준 %데미지 + 3 * 1레벨 상승 시 %데미지 상승량(%p)) + 1레벨 상승 시 %데미지 상승량(%p) / (현재 레벨 기준 %데미지 + 4 * 1레벨 상승 시 %데미지 상승량(%p))) / 5임.
        - 평균 스킬 데미지 상승량은 (이 스킬을 5레벨 연속으로 강화했을 시의 데미지 합산 수치) / 5 임.
      - 5레벨 상승 시 평균 최종데미지 상승율, 5레벨 상승 시 100억당 평균 최종데미지 상승율 = 강화효율을 산출하는 함수(재화 효율, 마스터리 코어[스킬][점유율], 마스터리 코어[스킬][스킬])
