...
4. 분석 보고서 - 점유율 편<br>
  ...
  &emsp;3. 패치 '후' 35초 스펙터 / 20초 레프 / 25초 스펙터 / 30초 레프 구조 + 허수아비형 보스 기준 링 익스체인지 '있이' 6분 주기.<br>
  분석 전제조건<br>
  &emsp;1. 기존 테스트 전제조건과 동일.[>> 전제조건 확인하러 가기(하이퍼링크 제작 예정)](#)<br>
  <b><분석 결과></b><br>

| 전투 횟수 | 패치 전 링 익스체인지 사용 | 전투 경험 개선 후(2) | 전투 경험 개선 후(3) |
|:---:|:---:|:---:|:---:|
...
| 평균 | 조 억 | 조 억 | 301조 5426억 |
  ...
  &emsp;위의 표를 보아, 2번과 3번의 데미지 차이가 % 나는 것으로 보아, 패치 이후에는 3번 구조를 필히 사용해야합니다. 3번의 데미지는 1번의 데미지 보다 1.08% 높다는 것을 알 수 있습니다.<br>
  
  &emsp;다음으로, 1번과 3번의 스킬 점유율 비교입니다.
...
| 플레인 차지드라이브VI | 3.39% | 4.15% | 122.42% |
  ...
  &emsp;스킬 점유율들이 상당하게 변화된 것을 볼 수 있습니다.<br>
  &emsp;'다가오는 죽음'의 점유율이 8%p 줄었고, 그 데미지의 상당 부분(3.67%p)이 '잊혀지지 않는 흉몽VI'로 이관 되었음을 알 수 있었습니다.<br>

  &emsp;다음은 연계 스킬 점유율을 종합한 결과를 확인해 보겠습니다.
...
| 플레인 차지드라이브VI | 4.84% | 5.44% | 112.58% |
  ...
  &emsp;[>> 상세 정보 보러가기(하이퍼링크 제작 예정)](#)<br>

  &emsp;'잊혀지지 않는 흉몽VI'과 연계되는 스킬들의 밸류가 상당히 높아졌습니다. '플레인 차지드라이브VI' 또한 '다가오는 죽음'의 점유율을 일부 가져간 모습을 확인해 볼 수 있습니다.<br>
  
  <b><분석 결론></b><br>
  &emsp;이 데이터는 특정 스킬의 비중을 줄이고 다른 스킬들의 효율을 높여 강화 효율을 개선하려는 게임사의 의도를 명확하게 보여줍니다.<br>
