...
3. 분석 보고서 1편<br>
  ...
  &emsp;- 링 익스체인지 미사용의 측정된 값 중 평균적인 범위에서 벗어나는 데이터가 확인되어, 총 2번의 추가 측정을 통해 데이터의 일관성을 확보했습니다.
  &emsp;- 추가적으로 링 익스체인지 사용으로 1번의 추가 측정을 통해 기존 데이터 무결성을 확인하였습니다. [>> 테스트 결과 모두 보기(하이퍼 링크 제작 예정)](#)
