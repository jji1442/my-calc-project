...
이 패치에 단점만 있지 않았습니다. 극딜 시간을 줄이고, 준극딜을 만들었으니 준극딜이 유효하게 작용하는 경우가 있습니다. 예를 들어,
   ...
   3. 극딜 사용 후 다음 페이즈로 넘어가는 과정(애니메이션 재생됨)에서 극딜 지속시간의 손해를 덜 볼 수 있게 된 경우.
...
#### 주관적인 평가
이번 패치는 만족하고 있습니다. 직업의 개성에 맞게 받아낼 요소들을 다 받아내어 데미지가 꽤나 늘어났고, 구조적으로 편해졌습니다. 극딜을 30초로 압축하여 사용할 경우 극딜 30초 이후에는 게이지 관리를 취향에 맞게 사용하면 된다는 점이 좋았습니다. 게이지 관리하는 점이 비교적 여유로워졌기 때문에 '근원의 기억', 어센트 스킬을 유동적으로 사용해도 되도록 변경되었습니다. 
