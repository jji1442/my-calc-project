...
## 7. 게임사 패치에 대한 평가.
25.08.21 기준 직업 전투 경험 개선 목적으로 아크는 '링 익스체인지' 스킬과 '최종데미지 6% 증가' 패시브를 받았습니다.<br>
'링 익스체인지'로 인한 코어 강화 효율 변화를 측정하고 이에 대한 평가를 해보려고 합니다.<br>
...
<br>
'링 익스체인지'라는 스킬 추가로 인해 아크는 2분 주기 버프의 지속시간 중에 특수 스킬 반지 2개를 사용할 수 있게 되어, 더욱 더 높은 피해량을 뽑아 낼 수 있게 되어 테스트용 데이터를 재측정하려고 합니다.<br>
