...
- 메인 함수
  ...
  3. 마스터리 코어와 마스터리 코어 패시브인 %p 체크하기. 두 스킬 현재 퍼뎀 조정하기.(% + %p)
  4. While(True):
    5. 마스터리 코어 리스트 = 마스터리 코어별로 강화효율 산출하는 함수(마스터리 코어 리스트)
    6. 마스터리 코어 번호, 강화 횟수 = 강화 추천하는 함수(마스터리 코어 리스트)
    7. if not 결과를 출력하는 함수(마스터리 코어 번호, 강화 횟수):
        7. break
    8.점유율 재조정.(%)
