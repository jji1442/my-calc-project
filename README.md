...
이 변경으로 '증오의 연쇄'를 제외한 극딜 이후, '링 익스체인지'를 통해 '웨폰퍼프 링'으로 교체하여 '증오의 연쇄'와 함께 추가적인 데미지를 넣는 새로운 빌드가 등장했습니다. 이는 과거 아크의 극딜 구조와 유사한 구조입니다. 이 빌드가 가능한 핵심 이유는 '인피니티 스펠'의 '다가오는 죽음' 사출량 증가로 인해 최대 징표까지 생성하는데 충분하기 때문입니다. 그러나 이 빌드는 개발진의 '이론과 실전의 괴리율 감소'라는 패치 기조와 상충될 가능성이 높습니다. 이 구조가 의도치 않은 '긴 극딜' 구조를 형성함에 따라, 준극딜에 전투스킬반지 변경하는 행위의 편의성을 제공하려는 개발 의도와 상충되어 후속 조정이 예상됩니다. 예상되는 조정 방안으로는 극딜 이후 연계 사용을 막기 위해 '징표 생성 확률 증가' 기능 삭제가 될 가능성이 높습니다.
...
#### 주관적인 평가
보스 패턴 및 컷신 때문에 극딜 시간 날리는 문제도 있고 게이지도 넉넉한 편이 아니기 때문에 평딜 구간에서 생존을 위해 스펙터로 변신하게 되면 다음 극딜 시간이 줄어버리는 문제도 있어, 극딜 압축은 필연적이라고 생각합니다. 그래서 '인피니티 스펠' 지속시간 30초로 줄이는 패치 나쁘지 않았지만, '증오의 연쇄'가 문제입니다. 인피니티 스펠 이후 이어서 사용하자니 증오의 연쇄를 2번(극딜 - 준극딜) 사용하는 것보다 손해보고, 그렇다고 준극딜에 쓰자니 극딜 버프 손해보고. 이도저도 아닌 스킬 느낌입니다. 심지어 유저들이 굉장히 싫어하는 돌아오는 증오의 부가 효과니 더더욱 말이 많았다고 생각합니다.
