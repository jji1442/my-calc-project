...
<img src="trial_and_error_img/acore_enh_eff.png">
<br>
이후 메이플스토리에 어센트 스킬이 추가되었습니다. 어센트 스킬은 한 보스에서 '쿨타임과 관계 없이 스킬을 최대 3번을 연속으로 사용 가능'합니다. 보스 클리어 타임이 6분(오리진 스킬의 쿨타임이 6분인 점을 고려하여 효율 측정함)을 기준으로 효율 측정하였을 때 연속적으로(2레벨에서 9레벨까지) 강화하는 것이 효율이 좋다는 것을 확인하였고, 위 가설에 추가 테스트를 진행해 보았습니다.<br>
