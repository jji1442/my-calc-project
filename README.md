...
- 환산주스탯(=효율분석 사이트)의 특징<br>
  ...
  &emsp;- 하지만 그 이상적인 세팅과 다르거나 다른 전투방식을 사용하는 경우, 전투 데이터를 제출한 유저와 강화효율의 차이가 클 수 있습니다.<br>
  2.&nbsp;반영되지 않는 요소들.<br>
  &emsp;- 재화 시세는 반영하나 사용하고 있는 '스킬 쿨타임 감소'나 '특수 반지 스킬' 같은 변수들을 반영하지 않으며 헥사코어 스킬 레벨에 따른 효율 변화가 없는 고정적인 강화순서를 제공합니다.
