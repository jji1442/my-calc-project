...
4. 분석 보고서 2편<br>
  ...
  실전 기준 평균적으로 허수아비형 보스의 85 ~ 90% 피해를 입힘(중간값 기준 2.5% 내외 실전 기준으로 테스트하므로, 데미지 편차가 2.5%가량 발생한다고 판단.).
...
| 평균 | 257조 4171억 |
  ...
  &emsp;최초의 대적자에서 평균적인 딜량의 86.29% 수준인 257조 4171억을 기록했습니다.<br>
...
'잊혀지지 않는 흉몽VI'과 연계되는 스킬들의 점유율 종합 + 링 익스체인지 미사용
| 스킬 이름 | 1 | 2 | 3 | 4 | 5 |
|:---:|:---:|:---:|:---:|:---:|:---:|
...
'플레인 차지드라이브VI'과 연계되는 스킬들의 점유율(평균) + 링 익스체인지 미사용
| 스킬 이름 | 1 | 2 | 3 | 4 | 5 |
|:---:|:---:|:---:|:---:|:---:|:---:|
...
'잊혀지지 않는 흉몽VI'과 연계되는 스킬들의 점유율 종합 + 링 익스체인지 사용(수정해야함)
| 스킬 이름 | 1 | 2 | 3 | 4 | 5 |
|:---:|:---:|:---:|:---:|:---:|:---:|
| 지워지지 않는 상처VI | 1.77% | 1.89% | 1.89% | 1.83% | 1.74% |
| 걷잡을 수 없는 혼돈VI | 1.77% | 1.62% | 1.57% | 1.52% | 1.41% |
...
'플레인 차지드라이브VI'과 연계되는 스킬들의 점유율(평균) + 링 익스체인지 사용(수정해야함)
| 스킬 이름 | 1 | 2 | 3 | 4 | 5 |
|:---:|:---:|:---:|:---:|:---:|:---:|
| 잊혀지지 않는 악몽VI | 1.74% | 1.91% | 1.96% | 2.03% | 1.98% |
| 스칼렛 차지드라이브VI | 0.62% | 0.83% | 0.82% | 0.89% | 0.78% |
