...
기존: 일정 레벨 달성 시 최종데미지 상승율, 100억당 최종데미지 상승율을 산출.
변경: 일정 레벨 달성 시 최종데미지 상승율만 산출.
설명: 기능 분리.
...
설명: 효율 산출하는 함수, 강화효율을 산출하는 함수 2가지로 나눠놓은 이유는 해당 스킬에만 적용되는 스탯% 상승하는 효과(6차 스킬 코어 패시브), 직업별 부가효과 이 2가지 때문에 나눠놓음.
