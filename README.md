...
보스를 속박시키지 않고 '끝없는 고통' 스킬 사용 시 보스 패턴을 맞을 위험(패턴 적중 시 최종데미지 감소)이 있어, 1분 버프와 함께 사용하는 '끝없는 고통' 스킬은 제외하기로 하였습니다.

측정 방식은 다음과 같습니다.
전제조건. 2분 주기 스킬은 측정 중 3회, 1분 주기 스킬은 측정 중 6회로 제한한다.
1. 링 익스체인지 '사용하지 않고' 오리진 스킬을 포함한 6분 주기(최종데미지 6% 증가를 제외하여 계산)
(최종)
3. 노말 난이도의 신규 보스를 링 익스체인지 '사용하고' 오리진 스킬을 포함한 힘의 순환 3번(6분 주기)

위 2가지의 수치가 비슷하다면, 전투 경험 개선을 패치한 이유는 '최초의 대적자(신규 보스)'에 의한 것으로 추정됩니다.
