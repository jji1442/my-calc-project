...
스킬 점유율들이 상당하게 변화된 것을 볼 수 있습니다. '다가오는 죽음'의 점유율이 상당히(8.00%p) 줄었고, 그 점유율의 상당 부분(3.67%p)이 '잊혀지지 않는 흉몽VI'로 이관되었음을 알 수 있었습니다.
...
'잊혀지지 않는 흉몽VI'과 연계되는 스킬들의 밸류가 상당히(5.25%p) 높아졌습니다. '플레인 차지드라이브VI'과 연계되는 스킬들 또한 높아진(0.60%p) 모습을 확인해 볼 수 있습니다.
...
9월달 패치 후에 링 익스체인지 스킬 '없이' 측정된 기록이 없어, 전투경험개선으로 인한 데미지 상승량은 측정 불가합니다.
7월달 패치에 비해 데미지가 "9.10%" 상승하였습니다.
