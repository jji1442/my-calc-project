...
#### 추가 테스트
세 레벨(9레벨 추가함) 간 '매서풀VI'의 차이를 측정해보겠습니다.
...
이 데미지 상승율을 얻기 위해서 필요한 재화 개수는 총 430개(0레벨 -> 9레벨)고, 이 재화의 가치는 개당 700만 메소입니다. 재화 비용은 총 30.1억입니다.<br>
100억당 최종데미지 상승율을 구하면, 0.4972 * (100 / 30.1) = 1.6518<br>
100억당 최종데미지 1.6518% 상승한다는 점을 알 수 있습니다.<br>
개발자의 캐릭터가 강화를 진행하고 있는 구간의 효율이 100억당 최종데미지 2.343% 상승하는 지점이라는 점을 고려했을 때, 이 공용코어의 효율은 현 시점에서 경쟁 스펙업 수단들에 비해 굉장히 낮다는 결론이 나옵니다.
