...
1. 보고서 작성 기간<br>
  25.09.17 ~ 25.00.00
2. 패치 내용<br>
  개선 항목과 변경 항목으로 나눠 설명하겠습니다.<br>
  &emsp;
  <개선 항목><br>
    1.test<br>
&emsp;&emsp;1. 스킬 딜레이 감소 + '전투광란' 상시로 변경.<br>
&emsp;&emsp;2. '기어다니는 공포' 키다운 중 HP 소모에서 MP 소모로 변경.<br>
&emsp;&emsp;3. '끝없는 고통'의 쿨타임 60초에서 120초로 변경.<br>
&emsp;&emsp;4. '영원히 굶주리는 짐승' 스킬 시퀀스에 추가 가능.<br>

&emsp;<변경 항목><br>
&emsp;&emsp;1. '인피니티 스펠' 지속시간을 50초에서 30초로 변경.<br>
&emsp;&emsp;2. 신규 버프 스킬 '증오의 연쇄' 추가.<br>
&emsp;&emsp;3. '영원히 굶주리는 짐승'의 총 %데미지 감소, 해당 스킬로 인한 '다가오는 죽음' 사출횟수 감소.<br>
&emsp;&emsp;4. '끝없는 고통'의 총 %데미지 감소, 해당 스킬로 인한 '다가오는 죽음' 사출횟수 감소.<br>
&emsp;&emsp;5. '거스트 차지드라이브VI', '어비스 차지드라이브VI' %데미지 소폭 상승.<br>
&emsp;&emsp;6. '걷잡을 수 없는 혼돈VI', '채워지지 않는 굶주림VI' %데미지 대폭 상승.<br>
