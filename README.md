...
다음은 '잊혀지지 않는 흉몽VI'과 연계되는 스킬들의 점유율과 '플레인 차지드라이브VI'과 연계되는 스킬들의 점유율 입니다.

'잊혀지지 않는 흉몽VI'과 연계되는 스킬들의 점유율
| 스킬 이름 | 링 익스체인지 미사용 | 링 익스체인지 사용 | 비교 |
|:---:|:---:|:---:|:---:|
|  | % | % | % |
|  | % | % | % |
...
보고서 작성 기간: 9월 17일 ~
게임사에서 아크의 직업 전투 경험 개선을 하여 개선 이전에 아크의 문제점을 작성하고,
개선 이후, 아크의 직업 전투 경험 개선이 어떻게 수정되었는지 확인해보려고 합니다.

이 문서는 지극히 개발자의 주관적인 생각이 다소 포함되어 있음을 알립니다.

<기본적인 직업 구조 설명 및 주관적인 개발자의 직업 문제점>

제자리에서 사용이 가능한 스킬과 이동형 스킬을 연계하여 사용합니다.

스펙터 상태는 기동성이 좋은 스킬 구조
레프 상태는 60초 동안 지속(버프 지속 시간 증가 효과에 영향을 미침)되는 버프를 동반한 스킬 구조입니다.
