...
- 메인 함수
  ...
  4. 마스터리 코어 번호, 스킬 강화 횟수 = 마스터리 코어별로 강화효율 확인하는 함수(마스터리 코어 리스트)
  5. 마스터리 코어 추천 및 강화.
  6. 모든 마스터리 코어 점유율 변경.
...
- 정의한 함수.
  ...
  - 마스터리 코어별로 강화효율 확인하는 함수.
    ...
    - else:
      - 리턴값 =  (최댓값 번호 // 2) + 1, 5
        - 1번째 리턴값은 마스터리 코어 리스트[(최댓값 번호 // 2) + 1]가 강화효율이 제일 좋음.
        - 2번째 리턴값은 몇 레벨 강화했을 때 강화효율이 제일 좋음.
