...
6. 메르세데스 유니온 효과(스킬 쿨타임 6% 감소)를 적용하여 오리진 스킬(360초)의 실제 쿨타임은 338.4초임.<br>
&emsp;측정 기준을 소수점 첫 번째 자리에서 반올림하여 5분38초(338초)로 설정.<br>
&emsp;> 대부분의 유저들이 메르세데스 유니온 효과를 가지고 있지만, 스킬 쿨타임 감소 효과를 지닌 모자는 비교적 소수의 유저들이 사용하므로 제외하고 측정.
7. 2분 주기 스킬은 총 3번으로 제한.<br>
&emsp;> 개발자의 아크는 스킬 쿨타임 2초 감소인 모자를 착용 중. 338초 기준으로 측정 시, 4회차 2분 주기 스킬을 6초 가량 사용할 수 있어 제한.
8. 어센트 스킬은 시간 내에 가장 딜로스 적은 구간에서 1회 사용.
9. 개발자 기준 모든 도핑 사용, 어센틱 포스 요구치 1, 보스 레벨 250, 방어율 380%, 체력 무한, 대형, 반감 기준으로 측정.
