...
3. 분석 보고서 - 점유율 편<br>
  ...
  <u>분석 전제조건</u><br><div id="25.08.21_rate_prerequisites"></div>
...
| 평균 | 292조 9493억 | 298조 3243억 |
  ...
  &emsp;&emsp;- 추가적으로 링 익스체인지 사용으로 1번의 추가 측정을 통해 기존 데이터 무결성을 확인하였습니다.<br>
  &emsp;&emsp;[>> 링 익스체인지 미사용 분석 결과 자세히 보러가기](#unused_ring_exchange_img)<br>
  &emsp;&emsp;[>> 링 익스체인지 사용 분석 결과 자세히 보러가기](#used_ring_exchange_img)<br>
  
  &emsp;&emsp;링 익스체인지 사용으로 인한 데미지 상승량은 "1.83%"이며, 이로 인한 아크의 일부 스킬별 점유율 변화는 다음과 같습니다.<br>
  
  &emsp;&emsp;1. 링 익스체인지에 영향이 미치는 스킬들 - 다가오는 죽음, 깨어난 심연, 돌아오는 증오VI, 잊혀지지 않는 흉몽VI.<br>
  &emsp;&emsp;2. 링 익스체인지에 영향이 미치지 않는 스킬들 - 영원히 굶주리는 짐승, 근원의 기억, 끝없는 고통VI, 플레인 차지드라이브VI.<br>
...
4. 분석 보고서 - 전투 구조 편<br>
  ...
  **<분석 결과>**<br>
  ...
  &emsp;&emsp;아크는 변신을 통해 전투 형태가 전환되는 직업입니다. 변신 전을 레프 상태, 변신 후를 스펙터 상태라고 합니다. 레프 상태에서는 공격 시 '적중 시 아크에게 버프를 부여하는 스펠'이 사출되며, 스펙터 상태에선 공격 시 '다가오는 죽음'이 사출됩니다.<br>
  ...
  &emsp;&emsp;&emsp;- '기어다니는 공포': 키다운 중 무적상태지만 HP를 지속적으로 소모하며 키다운 중 공격이 불가능(최대 5초간 키다운 가능, 쿨타임 60초)<br>&emsp;&emsp;- 문제점: '기어다니는 공포'는 키다운 중 공격을 못할 뿐만 아니라, HP 소모가 불가능할 경우 무적 상태가 해제되는 구조적 문제를 가지고 있습니다.<br>
  &emsp;&emsp;&emsp;- '기어다니는 공포': 키다운 중 무적상태지만 HP를 지속적으로 소모하며 키다운 중 공격이 불가능(최대 5초간 키다운 가능, 쿨타임 60초)<br>&emsp;&emsp;- 개선 방안: 다른 직업들과 유사하게 2초간 무적 상태와 동시에 공격이 가능하도록 개선이 필요합니다.<br>
  ...
  &emsp;&emsp;기존 구조에는 전투 중 유도리 있게 사용(극딜 버프 사용 후 37초 내에 사용)하면 되었지만, 변경된 구조는 극딜 버프 사용 후 16초 내에 사용해야 하므로 극딜 사이클에 강제적으로 추가되었습니다. '극딜 - 준극딜 구조'로 변경할 예정이었다면, '근원의 기억'의 게이지 소모되지 않는 방식을 삭제하고 기본적인 게이지 양을 늘리는 방식으로 변경했어야 하며 '근원의 기억' 사용 중 게이지를 소모되지 않게 수정해야 한다고 생각합니다. 전투경험개선이라는 명목으로 구조 개선을 했지만, 캐릭터의 안정성이 굉장히 하락했음을 알 수 있었습니다.<br>
  ...
  &emsp;&emsp;하지만, 그 결과 실전 데미지는 처참해졌습니다. 허수아비형 보스들의 경우 '돌아오는 증오'의 징표를 15스택 쌓기 수월했지만, 이동형 보스를 상대로는 15스택 조차 쌓기가 어려웠습니다. 돌아오는 증오의 적중율 또한 이동형 보스의 '텔레포트', '돌진'으로 인해 맞추기 힘든 것도 한 몫합니다.<br>
...
**<분석 결론>**<br>
  ...
  &emsp;&emsp;이는 아크의 전투경험을 불쾌하게 변경한 패치로 판단됩니다. 이로 인해 해당 직업의 핵심적인 재미가 훼손되었다고 판단하였고, 이 프로젝트의 강화효율을 측정하기 위한 대상을 엔젤릭 버스터로 변경했습니다.<br>
...
4. 분석 보고서 - 점유율 편<br>
  ...
  **<분석 방법>**<br>
  분석 종류<br>
  &emsp;1. 패치 '전' 55초 스펙터 / 55초 레프 구조 + 허수아비형 보스 기준 링 익스체인지 '있이' 6분 주기.<br>
  &emsp;2. 패치 '후' 55초 스펙터 / 55초 레프 구조 + 허수아비형 보스 기준 링 익스체인지 '있이' 6분 주기.<br>
  &emsp;3. 패치 '후' 34초 스펙터 / 21초 레프 / 24초 스펙터 / 31초 레프 구조 + 허수아비형 보스 기준 링 익스체인지 '있이' 6분 주기.<br>
  분석 전제조건<br>
  &emsp;1. 기존 전제조건과 동일. [>> 전제조건 보러가기](#25.08.21_rate_prerequisites)<br>
  **<분석 결과>**<br>
...
본 문서는 주관적인 내용을 '많이' 포함하고 있으며, 패치 분석 보고서(25.09.18)의 내용과 일부 유사함을 알립니다.

개발자는 캐릭터를 선택할 때, 먼저 캐릭터 개성과 스킬 세팅을 중심적으로 봅니다.

아크는 2가지의 개성을 지녔습니다.
타격감, 우월한 유틸리티입니다.
이 타격감이 좋은 이유가 '인피니티 스펠'에 의해 '다가오는 죽음'의 사출량이 증대되어, 적을 공격하는 맛이 있었습니다.
다만, 최근 패치로 인해 이 인피니티 스펠 지속시간 줄어 아크의 재미가 줄었습니다.

다음으로 우월한 유틸리티입니다.
스펙터 상태에선 슈퍼 스탠스(보스 공격에 밀리지 않음), 연계 스킬을 단일로 사용 시 빠른 기동성을 보여줍니다.
그리고, 해방 무기를 얻으면 사용할 수 있는 해방 무적을 포함한 무적 스킬이 3개(평균적으로 2개).
유틸리티 부분에서는 우월하다고 볼 수 있습니다.

다만, 스킬 단편적으로 시전 딜레이와 시전 후 딜레이가 있습니다.
이것을 어디서 체감했냐면.
진 힐라, 검은 마법사 3페이즈, 세렌, 칼로스에서 경험하였습니다.
진 힐라는 시전 모션이 길고, 후 딜레이가 길어서 실 맞고 데카아웃하는 경우가 빈번하였고,
검은 마법사 3페이즈는 후 딜레이가 길어서 검은 마법사의 밀치기 공격을 숙이지 못하는 경우가 빈번했습니다.
세렌 같은 경우, 1페이지의 장판 생성속도가 매우 빨라, 예측해서 피해야할 정도로 선 딜레이가 길었습니다.
칼로스는 시전 딜레이가 길어서 왼쪽 비석의 레이저, 맵에 생성되는 폭탄, 칼로스 자체의 레이저에 맞아 죽는 경우가 허다했습니다.

사실상 딜레이가 긴 대신 우월한 유틸리티를 줬다고 봐도 무방합니다.
물론, 개발자 본인이 플레이를 못하는 것도 맞습니다



개인적으로 감당할 수 있는 스킬 세팅에 한계가 있기 때문에, 스킬이 비교적 많지 않아야합니다.
그리고 스킬 세팅에서 서로 유기적으로 잘 맞는지, 어떤 구조가 편한지를 찾습니다.
아크로 예를 들면, 리스트레인트 링이 사용되는 시점에서는 연계를 하지 않는다.
기존의 아크 구조가 스펙터에서 딜하는것이 90%, 레프 상태에선 10%의 점유율을 차지했었습니다.
그럼으로 인해, 개발자인 본인은 레프 상태에서 딜하는 것을 포기하였고,
그로 인해, 전투광란 0~3스택이 왔다갔다 하는 경우가 생겼습니다.
기존에는 전투광란이라는 스킬이 20초간 연계속도를 상승시키는 스택형 스킬이었기 때문에 극딜 버프 올리고 끝없는 고통 후 연계하려고 보면,
이 스택이 없어져 연계 실수로 인해 리스트레인트 링의 범위를 벗아나는 경우가 허다했습니다.
이런 부분을 케어하고자, 리스트레인트 링 시간에는 연계하지 않는 사이클을 생성했습니다.
위와 같이 이러한 방법으로 저만의 사이클을 만드는 것이 가장 중요하다고 생각했고.
