...
전투 구조가 간단한 구조에서 다른 직업과 유사한 전투구조로 바뀌었고.

가장 큰 문제인 '근원의 기억(18초간 게이지 소모하지 않음 + 시전 중 무적)'을 극딜 사이클에 추가해야한다는 점이 가장 큰 발목을 잡게 되었습니다.
기존에는 극딜 버프 올린 후, 37초 내에 사용하면 문제가 없었으나, 변경된 이후에는 극딜 버프 올린 후, 16초 내에 사용해야합니다.
사실상 기존에는 전투 중 유도리 있게 사용하면 되었지만, 변경된 이후에는 16초 내에 넣어야하기 때문에 전투 중 무적기 하나가 사라졌습니다.
