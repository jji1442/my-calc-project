...
9레벨 달성하는데 필요한 재화 개수는 총 430개(0레벨 -> 9레벨)고, 재화 가치는 개당 700만 메소입니다. 재화 비용은 총 30.1억 메소입니다.<br>
100억 메소당 최종데미지 상승율을 구하면, 0.4972 * (100 / 30.1) = 1.6518<br>
100억 메소당 최종데미지 1.6518% 상승한다는 점을 알 수 있습니다.<br>

"이 부분은 약식으로 효율을 계산하였습니다."<br>
이어서 '매서풀VI' 8레벨 -> 9레벨의 효용가치 및 '매서풀VI' 9레벨 -> 14레벨 효용가치를 구해보자면,<br>
1레벨 -> 9레벨의 총 상승치 1.0704%이고, 상승 레벨 수치는 8레벨. 따라서, 1레벨당 최종데미지 상승치 0.1338%.<br>
8레벨 -> 9레벨의 재화 개수는 60개, 재화 가치는 700만 메소. 재화 비용은 총 4.2억 메소입니다.<br>
...
9레벨 -> 14레벨의 총 상승치는 0.669%.<br>
14레벨 달성하는데 재화 개수는 총 443개(9레벨 -> 14레벨), 재화 가치는 700만 메소, 재화 비용은 총 30.31억 메소입니다.<br>
100억 메소당 최종데미지 상승율을 구하면, 0.669 * (100 / 30.31) = 2.2072<br>
100억 메소당 최종데미지 2.2072% 상승한다는 점을 알 수 있습니다.

0레벨 -> 14레벨의 총 상승치는 0.4972 + 0.669% =1.1662.<br>
14레벨 달성하는데 재화 개수는 총 873개(0레벨 -> 14레벨), 재화 가치는 700만 메소, 재화 비용은 총 61.11억 메소입니다.<br>
100억 메소당 최종데미지 상승율을 구하면, 0.669 * (100 / 61.11) = 1.90<br>
100억 메소당 최종데미지 2.2072% 상승한다는 점을 알 수 있습니다.
...
개발자의 캐릭터가 강화를 진행하고 있는 구간의 효율이 100억 메소당 최종데미지 2.343% 상승한다는 점을 고려했을 때, 9레벨까지의 가치는 굉장히 낮음을 알 수 있으며,
