...
어떤것을 만들 것인가? 이런 것을 만들것이다.
그러면 이번엔 어느정도로 만들 것이냐? 이정도 크기로 만들 것이다.
...
6차 스킬 코어별
	적용 중인 보스 공격 시 데미지 증가, 방어율 무시 증가 수치를 저장하는 변수 추가.
...
스킬에 부여된 방어율 무시 상승함에 따른 데미지 증가하는 수치 측정하는 함수.
조건:　6차 스킬 코어 레벨 상승에 따른 보스 공격 시 데미지 증가 또는 방어율 무시가 상승했을 경우 및 마스터리 코어1의 보스 공격 시 데미지 증가했을 경우.
