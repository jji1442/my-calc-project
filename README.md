...
이어서 '매서풀VI' 8 -> 9레벨의 효용가치 및 '매서풀VI' 9 -> 14레벨 효용가치를 구해보자면,<br>
1 -> 9레벨의 총 상승치 1.0704%이고, 상승 레벨 수치는 8레벨. 따라서, 1레벨당 최종데미지 상승치 0.1338%.<br>
...
"이 부분은 약식으로 효율을 계산하였습니다."<br>
0 -> 14레벨의 총 상승치는 0.4972 + 0.669 = 1.1662%.<br>
...
0 -> 9레벨의 가치보다 0 -> 14레벨의 가치가 더 높다는 것을 통해, 부가효과 변경으로 인해 14레벨에도 영향을 미치고 있다는 점을 알 수 있습니다.

예상하기론 14 ~ 17레벨 구간이 변곡점으로 작용될 것으로 예상되며, 그 100억 메소당 최종데미지 수치는 2% 정도라고 예상됩니다.

개발자의 캐릭터가 강화를 진행하고 있는 구간의 효율이 100억 메소당 최종데미지 2.343% 상승한다는 점을 고려했을 때, 9레벨까지의 가치는 굉장히 낮음을 알 수 있습니다.

0레벨과 9레벨 간의 실측 데이터가 100억 메소당 최종데미지 1.6518% 상승한다는 점, 환산주스탯에서 나오는 14레벨의 100억당 최종데미지 1.714%를 고려했을 때, 환산 사이트의 14레벨 때 달성 가치가 있다고 생각합니다.
