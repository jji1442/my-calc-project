...
이러한 주요 버프틀의 지속시간은 새로운 전투 구조와 맞지 않아 버프 효과를 온전히 활용하지 못하는 상황이 생겼습니다.
이로 인해, '인피니티 스펠'의 강화효율도 낮아지는 결과를 초래했습니다.

또한, '근원의 기억'을 극딜 사이클에 강제적으로 추가해야한다는 점이 문제점으로 작용되었습니다.
'근원의 기억': 18초간 게이지 소모하지 않으며, 시전 중 무적.
기존 구조: 전투 중 유도리 있게(37초 내에 사용) 사용
변경된 구조: 16초 내에 넣어야하기 때문에 필연적으로 극딜 사이클에 추가해야함.
전투 중 무적기 하나가 없어진 꼴이 되었습니다.
