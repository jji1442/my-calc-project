...
전 캐릭터를 선택할 때 먼저 캐릭터 개성과 스킬 세팅을 중심적으로 봅니다.

아크는 2가지의 개성을 지녔습니다.
타격감, 우월한 유틸리티입니다.
이 타격감이 좋은 이유가 인피니티 스펠 때문인데,
최근 패치로 인해 이 인피니티 스펠 지속시간이 줄어 할 맛이 안난다고 생각이 듭니다.
2차적으로 우월한 유틸리티.
슈퍼스탠스, 해방 무기를 얻으면 받을 수 있는 해방 무적을 포함한 무적 스킬이 3개,
스펙터 상태에서 우월한 맵 장악력으로
솔직히 말도 안되는 유틸을 가지고 있다고 봐도 무방합니다.
